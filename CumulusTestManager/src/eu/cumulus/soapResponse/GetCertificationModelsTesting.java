/**
 * GetCertificationModelsTesting.java
 *
...
/**
 * GetCertificationModelsTesting bean class
 */
@SuppressWarnings({ "unchecked", "unused" })
public class GetCertificationModelsTesting implements
		org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://testingpkg.cumulus.eu", "getCertificationModelsTesting",
			"ns1");
	 ...
	 * @return java.lang.String
	 */
	public java.lang.String getTOC_ID() {
		return localTOC_ID;
	}
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null)
				...
				writeAttribute("xsi",
						...
						namespacePrefix + ":getCertificationModelsTesting",
						xmlWriter);
			} else {
				writeAttribute("xsi",
						"http://www.w3.org/2001/XMLSchema-instance", "type",
						"getCertificationModelsTesting", xmlWriter);
			}
	...
	public static class Factory {
		 ...
		 * outer element
		 */
		public static GetCertificationModelsTesting parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			GetCertificationModelsTesting object = new GetCertificationModelsTesting();
			...
			try {
				...
				if (reader.getAttributeValue(
					...
					if (fullTypeName != null) {
						...
						if (!"getCertificationModelsTesting".equals(type)) {
							// find namespace for the prefix
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (GetCertificationModelsTesting) eu.cumulus.soapResponse.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if (!"true".equals(nillableValue)
						...
						object.setTOC_ID(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(content));
