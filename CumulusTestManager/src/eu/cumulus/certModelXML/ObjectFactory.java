...
public class ObjectFactory {
	 ...
	 * {@link LifeCycleType.LifeCycleStates.LifeCycleTransitions }
	 * 
	 */
	public LifeCycleType.LifeCycleStates.LifeCycleTransitions createLifeCycleTypeLifeCycleStatesLifeCycleTransitions() {
		return new LifeCycleType.LifeCycleStates.LifeCycleTransitions();
	}
	...
	/**
	 * Create an instance of {@link LifeCycleType.LifeCycleStates }
	 * 
	 */
	public LifeCycleType.LifeCycleStates createLifeCycleTypeLifeCycleStates() {
		return new LifeCycleType.LifeCycleStates();
	}
	...
	public JAXBElement<String> createCapabilityTypeAttacker(String value) {
		return new JAXBElement<String>(_CapabilityTypeAttacker_QNAME,
				String.class, CapabilityType.class, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link CapabilityType.AttackerCapabilities }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "", name = "AttackerCapabilities", scope = CapabilityType.class)
	public JAXBElement<CapabilityType.AttackerCapabilities> createCapabilityTypeAttackerCapabilities(
			CapabilityType.AttackerCapabilities value) {
		return new JAXBElement<CapabilityType.AttackerCapabilities>(
				_CapabilityTypeAttackerCapabilities_QNAME,
				CapabilityType.AttackerCapabilities.class,
				CapabilityType.class, value);
	}
	...
	public JAXBElement<String> createCapabilityTypeAttackName(String value) {
		return new JAXBElement<String>(_CapabilityTypeAttackName_QNAME,
				String.class, CapabilityType.class, value);
	}
	...
	public JAXBElement<byte[]> createTCHash(byte[] value) {
		return new JAXBElement<byte[]>(_TCHash_QNAME, byte[].class, null,
				((byte[]) value));
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link TestBasedCertificationModelType }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "", name = "TestBasedCertificationModel")
	public JAXBElement<TestBasedCertificationModelType> createTestBasedCertificationModel(
			TestBasedCertificationModelType value) {
		return new JAXBElement<TestBasedCertificationModelType>(
				_TestBasedCertificationModel_QNAME,
				TestBasedCertificationModelType.class, null, value);
	}

	/**
	 * Create an instance of {@link JAXBElement }{@code <}
	 * {@link SecurityPropertyType }{@code >}
	 * 
	 */
	@XmlElementDecl(namespace = "", name = "TestedSecurityProperty")
	public JAXBElement<SecurityPropertyType> createTestedSecurityProperty(
			SecurityPropertyType value) {
		return new JAXBElement<SecurityPropertyType>(
				_TestedSecurityProperty_QNAME, SecurityPropertyType.class,
				null, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "", name = "LifeCycleId", scope = LifeCycleType.LifeCycleStates.class)
	@XmlJavaTypeAdapter(CollapsedStringAdapter.class)
	@XmlID
	public JAXBElement<String> createLifeCycleTypeLifeCycleStatesLifeCycleId(
			String value) {
		return new JAXBElement<String>(
				_LifeCycleTypeLifeCycleStatesLifeCycleId_QNAME, String.class,
				LifeCycleType.LifeCycleStates.class, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "", name = "LifeCycleState", scope = LifeCycleType.LifeCycleStates.class)
	public JAXBElement<String> createLifeCycleTypeLifeCycleStatesLifeCycleState(
			String value) {
		return new JAXBElement<String>(
				_LifeCycleTypeLifeCycleStatesLifeCycleState_QNAME,
				String.class, LifeCycleType.LifeCycleStates.class, value);
	}
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "", name = "LifeCycleTransitions", scope = LifeCycleType.LifeCycleStates.class)
	public JAXBElement<LifeCycleType.LifeCycleStates.LifeCycleTransitions> createLifeCycleTypeLifeCycleStatesLifeCycleTransitions(
			LifeCycleType.LifeCycleStates.LifeCycleTransitions value) {
		return new JAXBElement<LifeCycleType.LifeCycleStates.LifeCycleTransitions>(
				_LifeCycleTypeLifeCycleStatesLifeCycleTransitions_QNAME,
				LifeCycleType.LifeCycleStates.LifeCycleTransitions.class,
				LifeCycleType.LifeCycleStates.class, value);
	}
	...
	public JAXBElement<Object> createKeyInfoTypeRetrievalMethod(Object value) {
		return new JAXBElement<Object>(_KeyInfoTypeRetrievalMethod_QNAME,
				Object.class, KeyInfoType.class, value);
	}
	...
	public JAXBElement<Object> createKeyInfoTypeSPKIData(Object value) {
		return new JAXBElement<Object>(_KeyInfoTypeSPKIData_QNAME,
				Object.class, KeyInfoType.class, value);
	}
	...
	public JAXBElement<Object> createKeyInfoTypeKeyValue(Object value) {
		return new JAXBElement<Object>(_KeyInfoTypeKeyValue_QNAME,
				Object.class, KeyInfoType.class, value);
	}
	...
	public JAXBElement<Object> createKeyInfoTypeX509Data(Object value) {
		return new JAXBElement<Object>(_KeyInfoTypeX509Data_QNAME,
				Object.class, KeyInfoType.class, value);
	}
	...
	public JAXBElement<Object> createKeyInfoTypePGPData(Object value) {
		return new JAXBElement<Object>(_KeyInfoTypePGPData_QNAME, Object.class,
				KeyInfoType.class, value);
	}
	...
	public JAXBElement<Object> createKeyInfoTypeMgmtData(Object value) {
		return new JAXBElement<Object>(_KeyInfoTypeMgmtData_QNAME,
				Object.class, KeyInfoType.class, value);
	}
	...
	public JAXBElement<Object> createKeyInfoTypeKeyName(Object value) {
		return new JAXBElement<Object>(_KeyInfoTypeKeyName_QNAME, Object.class,
				KeyInfoType.class, value);
	}
	...
	public JAXBElement<String> createEventBusCollectorTypeEventId(String value) {
		return new JAXBElement<String>(_EventBusCollectorTypeEventId_QNAME,
				String.class, EventBusCollectorType.class, value);
	}
	...
	public JAXBElement<String> createEventBusCollectorTypeEventCode(String value) {
		return new JAXBElement<String>(_EventBusCollectorTypeEventCode_QNAME,
				String.class, EventBusCollectorType.class, value);
	}
