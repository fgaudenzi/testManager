...
public class Toc implements Serializable {
	...
	public void setOperativeConditions(List<OperativeCondition> operativeConditions) {
		this.operativeConditions = operativeConditions;
	}

	public OperativeCondition addOperativeCondition(OperativeCondition operativeCondition) {
	...
	public OperativeCondition removeOperativeCondition(OperativeCondition operativeCondition) {
