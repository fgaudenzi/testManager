...
public class LyfeCycleTransitionsSaxParser extends DefaultHandler {
	...
	private boolean tran=false,subtran=true,negated=false; 
...
//        	System.out.println("START ANALYZING");
        	...
        	if(qName.equalsIgnoreCase("transition")){
            	System.out.println("startSingleTransistion From:"+ attributes.getValue("From")+" TO:"+attributes.getValue("To"));
            ...
            }if((qName.equalsIgnoreCase("LogicalExpression"))||(qName.equalsIgnoreCase("LogicalOperator")))
            	if((qName.equalsIgnoreCase("LogicalExpression"))&&(attributes.getValue("negated")!=null))
            			if(attributes.getValue("negated").equalsIgnoreCase("true"))
            				this.negated=true;
            			else
            				this.negated=false;
    ...
    throws SAXException {
    	 ...
    	 if(qName.equalsIgnoreCase("transition")){
    		...
    		formula=formula.trim().replaceAll(" +", " ");
    		 System.out.println("SAVED FORMULA:"+this.formula+"");
    		 //save transition
    		 ...
    		 this.transitions.add(new Trans(this.from,this.to,this.formula,cols));
    		 this.formula="";
