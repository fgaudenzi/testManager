...
public class Certificationmodel implements Serializable {
	...
	public void modifyXML_ID() {
		String xmlapp=this.xml;
		this.xml=xmlapp.replaceAll("<CertificationModelID>cumulus:cm:id:test:[0-9]*</CertificationModelID>", "<CertificationModelID>"+this.id+"</CertificationModelID>");
